...
import com.ankit.chatapp.testing.OpenForTesting
import com.ankit.chatapp.utils.extension.clear
...
class FirebaseViewModel @Inject constructor(
    ...
    val chatRoomList: MutableLiveData<List<Chat>?> = _chatRoomList
